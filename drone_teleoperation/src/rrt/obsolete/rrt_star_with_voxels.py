...
from ros_data import obtain_drone_odometry, publish_path_array_to_goal, publish_final_goal_reached,take_flag_inside_manouver, obtain_final_goal, publish_flag_to_enter_in_assistive_rrt_guidance, publish_obstacles_positions, take_flag_to_exit_rrt, publish_final_goal_position
...
class RRTStar(RRT):
    ...
    def find_goal_projection_on_drone_BF_horizon(self, final_goal_BF, init):
        ...
        if (self.X.obstacle_free(rel_goal_BF) == False or self.X.voxels_obstacle_free(rel_goal_GF,0.5) == False):
    ...
    def rrt_star(self, desired_folder_number):
        ...
        while counter_loop < condition:
            ...
            if (counter > 50 and horizon_goal_reached == False):
