...
import chart_studio
chart_studio.tools.set_credentials_file(username='lucamora', api_key='eULKjlZtP0PXQxK55qa5')
...
class Plot(object):
    def __init__(self, filename):
        ...
        """
        self.filename = "/home/luca/luca_ws/src/scene_understanding_pkg/src/rrt-algorithms/src/rrt/Plots/" + filename + ".html"
        self.data = []
    ...
    def draw(self, auto_open=True):
        ...
        """
        py.plot(self.fig, filename=self.filename, auto_open=auto_open)
