#ifndef _KIMERA_VIO_DATA_FOR_ROSBAG_H
#define _KIMERA_VIO_DATA_FOR_ROSBAG_H
...
class Kimera_vio_data_for_rosbag
{
    ...
    // Subscriber from rosbag to republish with teh correct timestamps 
    ros::Subscriber rrt_virtual_obstacles_marker_1_from_rosbag;
    ros::Subscriber rrt_virtual_obstacles_marker_2_from_rosbag;
    ros::Subscriber rrt_virtual_obstacles_marker_3_from_rosbag;
    ros::Subscriber rrt_line_to_follow_marker_from_rosbag;
    ros::Subscriber force_arrow_from_rosbag;
    ros::Subscriber rrt_final_goal_marker_from_rosbag;
    ros::Subscriber rrt_fixed_marker_manouver_marker_from_rosbag;
    ros::Subscriber interactive_marker_position;
    ...
    ros::Publisher holo_position_rviz_frame_mocap_sr;
    ros::Publisher holo_position_rviz_frame_world;
    ros::Publisher publish_interactive_marker_to_rviz;

    //From Rosbag
    ros::Publisher publish_v_marker_1_timestamp_corrected_rosbag;
    ros::Publisher publish_v_marker_2_timestamp_corrected_rosbag;
    ros::Publisher publish_v_marker_3_timestamp_corrected_rosbag;
    ros::Publisher publish_line_to_follow_marker_timestamp_corrected_rosbag;
    ros::Publisher publish_force_arrow_timestamp_corrected_rosbag;
    ros::Publisher publish_rrt_final_goal_timestamp_corrected_rosbag;
    ros::Publisher publish_rrt_fixed_marker_for_manouver_timestamp_corrected_rosbag;
   
    //TO Unity
    ros::Publisher publish_assistive_guidance_flag; 
    ros::Publisher publish_exit_RRT_search_mode;
    ros::Publisher publish_goal_marker_position;
    ros::Publisher publish_virtual_obstacles_to_unity;
    ros::Publisher publish_RRT_inside_bypass_manouver;
...
public:
    ...
    geometry_msgs::Point interaction_marker_position;
    ...
    geometry_msgs::Point virtual_obstacle_1;
    geometry_msgs::Point virtual_obstacle_2;
    geometry_msgs::Point virtual_obstacle_3;
    
    geometry_msgs::Vector3 v1_obs_scale;
    geometry_msgs::Vector3 v2_obs_scale;
    geometry_msgs::Vector3 v3_obs_scale;
    ...
    //For Unity when replaying from rosbag
    bool start_assistive_guidance = false;
    bool exit_search_mode = false;
...
//Parameters
    ...
    Kimera_vio_data_for_rosbag()
    {
        ...
        // Subscribers
        kimera_mesh = nh_.subscribe("/kimera_vio_ros/mesh", 50000, &Kimera_vio_data_for_rosbag::kimera_vio_mesh_callback, this);
        kimera_point_cloud = nh_.subscribe("/kimera_vio_ros/time_horizon_pointcloud", 50000, &Kimera_vio_data_for_rosbag::kimera_vio_pointcloud_callback, this);
        kimera_vio_odometry = nh_.subscribe("/kimera_vio_ros/odometry", 50000, &Kimera_vio_data_for_rosbag::kimera_vio_odometry_callback, this);
        Realsense_color_image = nh_.subscribe("/camera/color/image_raw", 50000, &Kimera_vio_data_for_rosbag::realsense_color_image_callback, this);
        python_check_feature_matching = nh_.subscribe("/feature_detector_py/feature_matching_flag", 50000, &Kimera_vio_data_for_rosbag::python_feature_detector_matching_callback, this);
        //subscribe to Realsense
        voxblox_mesh = nh_.subscribe("/voxblox_node_voxl_3/mesh", 50000, &Kimera_vio_data_for_rosbag::voxblox_mesh_block_callback, this);
        realsense_point_cloud = nh_.subscribe("/voxl3/dfs_point_cloud_GF", 50000, &Kimera_vio_data_for_rosbag::realsense_pointcloud_callback, this); /// camera/depth/color/points  ///voxl3/dfs_point_cloud
        image_proc_point_cloud =  nh_.subscribe("/stereo_gray/dense_stereo/pointcloud", 50000, &Kimera_vio_data_for_rosbag::image_proc_pointcloud_callback, this);
        //subscribe to Dragonfly Topic 
        dragonfly_imu = nh_.subscribe("/dragonfly8/imu", 50000, &Kimera_vio_data_for_rosbag::dragonfly_imu_callback, this); 
        dragonfly_vio_pose = nh_.subscribe("/qvio/odometry", 50000, &Kimera_vio_data_for_rosbag::dragonfly_vio_pose_callback, this); //dragonfly8/vio_pose
        ...
        voxl3_mocap_pose = nh_.subscribe("/voxl3/odom", 10, &Kimera_vio_data_for_rosbag::voxl3_mocap_pose_callback, this); ///voxl3/odom  ///voxl3/quadrotor_ukf/control_odom
        //quadrotor_sim_pose = nh_.subscribe("/quadrotor/odom", 10, &Kimera_vio_data::quadrotor_vio_pose_callback, this);
  
        start_stop_mapping_bool = nh_.subscribe("/from_Unity/start_stop_mapping", 50000, &Kimera_vio_data_for_rosbag::from_unity_start_stop_mapping_callback, this);
        restart_mapping = nh_.subscribe("/from_Unity/restart_mapping", 50000, &Kimera_vio_data_for_rosbag::from_unity_restart_mapping_callback, this);
        mocap_scene_root_in_unity_world = nh_.subscribe("/from_unity/mocap_frame_in_unity_world_coo", 50000, &Kimera_vio_data_for_rosbag::mocap_scene_root_in_unity_frame_callback, this);
        holoPosition = nh_.subscribe("/hololens_position", 50000, &Kimera_vio_data_for_rosbag::holo_position_callback, this);
       interactive_marker_unity_position_world = nh_.subscribe("/unity_to_ros/interactive_marker_position", 50000, &Kimera_vio_data_for_rosbag::from_unity_interactive_marker_callback, this);
       interactive_marker_position = nh_.subscribe("/interactive_marker_position", 50000, &Kimera_vio_data_for_rosbag::interactive_marker_position_callback, this);
       
        //From Rosbag
        rrt_virtual_obstacles_marker_1_from_rosbag =  nh_.subscribe("/rrt/virtual_obstacle_marker_1", 50000, &Kimera_vio_data_for_rosbag::virtual_obstacle_marker_1_from_rosbag_callback, this);
        rrt_virtual_obstacles_marker_2_from_rosbag =  nh_.subscribe("/rrt/virtual_obstacle_marker_2", 50000, &Kimera_vio_data_for_rosbag::virtual_obstacle_marker_2_from_rosbag_callback, this);
        rrt_virtual_obstacles_marker_3_from_rosbag =  nh_.subscribe("/rrt/virtual_obstacle_marker_3", 50000, &Kimera_vio_data_for_rosbag::virtual_obstacle_marker_2_from_rosbag_callback, this);
        rrt_line_to_follow_marker_from_rosbag = nh_.subscribe("/visualization_marker/line_to_follow", 50000, &Kimera_vio_data_for_rosbag::rrt_line_to_follow_from_rosbag_callback, this);
        force_arrow_from_rosbag =  nh_.subscribe("/visualization_marker/force_arrow", 50000, &Kimera_vio_data_for_rosbag::force_arrow_from_rosbag_callback, this);
        rrt_final_goal_marker_from_rosbag = nh_.subscribe("/rrt/final_goal_marker", 50000, &Kimera_vio_data_for_rosbag::rrt_final_goal_from_rosbag_callback, this);
        rrt_fixed_marker_manouver_marker_from_rosbag = nh_.subscribe("/rrt/fxed_marker_for_manouver", 50000, &Kimera_vio_data_for_rosbag::rrt_fixed_marker_for_manouver_from_rosbag_callback, this);
        ...
        holo_position_rviz_frame_mocap_sr = nh_.advertise<visualization_msgs::Marker>("hololens_frame_mocap_sr", 10);
        holo_position_rviz_frame_world = nh_.advertise<visualization_msgs::Marker>("hololens_frame_world", 10);
        publish_interactive_marker_to_rviz = nh_.advertise<visualization_msgs::Marker>("/interactive_marker_to_rviz", 10);
         
        //From ROSBAG
        publish_v_marker_1_timestamp_corrected_rosbag = nh_.advertise<visualization_msgs::Marker>("/rrt/v_obstacle_1_time_corrected", 10);
        publish_v_marker_2_timestamp_corrected_rosbag =  nh_.advertise<visualization_msgs::Marker>("/rrt/v_obstacle_2_time_corrected", 10);
        publish_v_marker_3_timestamp_corrected_rosbag =  nh_.advertise<visualization_msgs::Marker>("/rrt/v_obstacle_3_time_corrected", 10);
        publish_line_to_follow_marker_timestamp_corrected_rosbag = nh_.advertise<visualization_msgs::Marker>("/visualization_marker/line_to_follow_time_corrected", 10);
        publish_force_arrow_timestamp_corrected_rosbag = nh_.advertise<visualization_msgs::Marker>("/visualization_marker/force_arrow_time_corrected", 10);
        publish_rrt_final_goal_timestamp_corrected_rosbag = nh_.advertise<visualization_msgs::Marker>("/rrt/final_goal_time_corrected", 10);
        publish_rrt_fixed_marker_for_manouver_timestamp_corrected_rosbag = nh_.advertise<visualization_msgs::Marker>("/rrt/fixed_marker_for_manouver_time_corrected", 10);
        
        //From ROSBAG to UNITY
        publish_assistive_guidance_flag = nh_.advertise<std_msgs::Bool>("/rrt/start_assistive_guidance", 10);
        publish_exit_RRT_search_mode = nh_.advertise<std_msgs::Bool>("/rrt/exit_search_mode", 10);
        publish_goal_marker_position = nh_.advertise<geometry_msgs::Point>("/rrt/final_goal", 10);
        publish_virtual_obstacles_to_unity =  nh_.advertise<scene_understanding_pkg_msgs::RRTObstaclesCoo>("/rrt/virtual_obstacles_coo", 10);
        publish_RRT_inside_bypass_manouver =  nh_.advertise<std_msgs::Bool>("/rrt/inside_bypass_manouver", 10);
  ...
  void dragonfly_vio_pose_callback(const nav_msgs::Odometry &msg)
  {
   ...
   void mocap_scene_root_in_unity_frame_callback(const geometry_msgs::PoseStamped &msg)
    ...
    void holo_position_callback(const geometry_msgs::Point position)
    {

        hololens_position = position;
        flagHoloPosition = true;
    }


   void from_unity_interactive_marker_callback(const geometry_msgs::Point position)
   {
   ...
   {
        interaction_marker_position = position;
        flagInteractiveMarkerPosition = true;
   }
  ...
  //FROM ROSBAG 
  void virtual_obstacle_marker_1_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ros::Time stamp = ros::Time::now();
    msg_.header.stamp = stamp;
    virtual_obstacle_1 = msg_.pose.position;
    v1_obs_scale = msg_.scale;

    scene_understanding_pkg_msgs::RRTObstaclesCoo virtual_obstacle_to_unity_msg;
    string name = "obstacle_0";
    float x_coo_min = 0.0;
    float y_coo_min = 0.0;
    float x_coo_max = 0.0;
    float y_coo_max = 0.0;
   
    x_coo_min = virtual_obstacle_1.x - v1_obs_scale.x/2;
    y_coo_min =  virtual_obstacle_1.y - v1_obs_scale.y/2;
    x_coo_max = virtual_obstacle_1.x + v1_obs_scale.x/2;
    y_coo_max = virtual_obstacle_1.y + v1_obs_scale.y/2;
    
    geometry_msgs::Point coo_min;
    geometry_msgs::Point coo_max;
    coo_min.x = x_coo_min;
    coo_min.y = y_coo_min;
    coo_min.z = 0.5;
    ...
    virtual_obstacle_to_unity_msg.point.push_back(coo_min);
    virtual_obstacle_to_unity_msg.point.push_back(coo_max);
    virtual_obstacle_to_unity_msg.name = name;
    virtual_obstacle_to_unity_msg.number = 2;

    if (start_assistive_guidance == true)
    {
      publish_virtual_obstacles_to_unity.publish(virtual_obstacle_to_unity_msg);
      publish_v_marker_1_timestamp_corrected_rosbag.publish(msg_);
    }
  ...
  //FROM ROSBAG 
  void virtual_obstacle_marker_2_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ros::Time stamp = ros::Time::now();
    msg_.header.stamp = stamp;
    virtual_obstacle_2 = msg_.pose.position;
    v2_obs_scale = msg_.scale;
   

    scene_understanding_pkg_msgs::RRTObstaclesCoo virtual_obstacle_to_unity_msg;
    string name = "obstacle_1";
    float x_coo_min = 0.0;
    float y_coo_min = 0.0;
    float x_coo_max = 0.0;
    float y_coo_max = 0.0;
   
    x_coo_min = virtual_obstacle_2.x - v1_obs_scale.x/2;
    y_coo_min =  virtual_obstacle_2.y - v1_obs_scale.y/2;
    x_coo_max = virtual_obstacle_2.x + v1_obs_scale.x/2;
    y_coo_max = virtual_obstacle_2.y + v1_obs_scale.y/2;
    ...
    publish_v_marker_2_timestamp_corrected_rosbag.publish(msg_);
    }

  }
   //FROM ROSBAG 
  void virtual_obstacle_marker_3_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ros::Time stamp = ros::Time::now();
    msg_.header.stamp = stamp;
    virtual_obstacle_3 = msg_.pose.position;
    v3_obs_scale = msg_.scale;
   
     scene_understanding_pkg_msgs::RRTObstaclesCoo virtual_obstacle_to_unity_msg;
     string name = "obstacle_2";
    float x_coo_min = 0.0;
    float y_coo_min = 0.0;
    float x_coo_max = 0.0;
    float y_coo_max = 0.0;
   
    x_coo_min = virtual_obstacle_3.x - v1_obs_scale.x/2;
    y_coo_min =  virtual_obstacle_3.y - v1_obs_scale.y/2;
    x_coo_max = virtual_obstacle_3.x + v1_obs_scale.x/2;
    y_coo_max = virtual_obstacle_3.y + v1_obs_scale.y/2;
    ...
    publish_v_marker_3_timestamp_corrected_rosbag.publish(msg_);
    }

  }

  void rrt_line_to_follow_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ros::Time stamp = ros::Time::now();
    msg_.header.stamp = stamp;
    publish_line_to_follow_marker_timestamp_corrected_rosbag.publish(msg_);
  }

 void force_arrow_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ros::Time stamp = ros::Time::now();
    msg_.header.stamp = stamp;
    publish_force_arrow_timestamp_corrected_rosbag.publish(msg_);
  }

void rrt_final_goal_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ...
    //Set the flag start assistive guidance = true, exit_search_mode = false, /rrt/inside_bypass_manouver = false, /rrt/final_goal = true --publish also te position of the virtual obstacle as published from the python scripts
    if (msg_.pose.position.x + msg_.pose.position.y + msg_.pose.position.z > 0)
    {
        start_assistive_guidance = true;
        exit_search_mode = false;
        goal_marker_position = msg_.pose.position;
        publish_goal_marker_position_to_unity();

    }

    //Check the distance of teh drone from the final goal, if less than 10 cm send te nessage to unity to exit from RRT path
    float distance = sqrt(pow(msg_.pose.position.x -voxl3_position.x, 2 ) + pow(msg_.pose.position.y -voxl3_position.y, 2 ));
    if (distance < 0.10)
    {
        start_assistive_guidance = false;
        exit_search_mode = true;
    }
    publish_rrt_final_goal_timestamp_corrected_rosbag.publish(msg_);
  }

  void rrt_fixed_marker_for_manouver_from_rosbag_callback(const visualization_msgs::Marker &msg)
  {
    visualization_msgs::Marker msg_;
    msg_ = msg;
     //change time stamp with the actual time stamp 
    ...
    {
        bool flag = true;
        publish_rrt_inside_bypass_manouver(flag);
    }
    else
    {
        bool flag = false;
    ...
    //when something is published her, publish /rrt/inside_bypass_manouver = false
    publish_rrt_fixed_marker_for_manouver_timestamp_corrected_rosbag.publish(msg_);

  }

  

  //To unity when a rosbag is replayed
  void publish_start_assistive_guidance_flag(bool flag)
  {
     std_msgs::Bool flag_start_assistive;
     flag_start_assistive.data = flag;
     publish_assistive_guidance_flag.publish(flag_start_assistive);
     
  }

   void publish_exit_search_mode(bool flag)
  {
     std_msgs::Bool flag_exit_search_mode;
     flag_exit_search_mode.data = flag;
     publish_exit_RRT_search_mode.publish(flag_exit_search_mode);
     
  }
  

   void publish_goal_marker_position_to_unity()
  {
   
     publish_goal_marker_position.publish(goal_marker_position);
 ...
 void publish_rrt_inside_bypass_manouver(bool flag)
  {
     std_msgs::Bool flag_inside_bypass_manouver;
     flag_inside_bypass_manouver.data = flag;
     publish_RRT_inside_bypass_manouver.publish(flag_inside_bypass_manouver);
...
//   }
    ...
    odom_trans.transform.translation.x = voxl3_position.x;//hololens_position
    ...
    {
             //TF Publisher valuse 
    ros::Time current_time_tf, last_time_tf;//hololens_position
...
void publish_hololens_pose_in_RVIZ_frame_mocap_sr()
{
  visualization_msgs::Marker sphere;
    sphere.points.clear();

     sphere.header.frame_id = "/mocap_sr";
    ...
    // POINTS markers use x and y scale for width/height respectively
     ...
     sphere.color.b = 1.0f;
     sphere.color.a = 1.0;
     holo_position_rviz_frame_mocap_sr.publish(sphere);
}



void publish_hololens_pose_in_RVIZ_frame_world()
{
  visualization_msgs::Marker sphere;
    sphere.points.clear();
    ...
    // POINTS markers use x and y scale for width/height respectively
     ...
     holo_position_rviz_frame_world.publish(sphere);

}

void publish_interactive_marker_position_in_rviz()
{
     visualization_msgs::Marker sphere;
    sphere.points.clear();
    ...
    if (with_holo == true)
    {
        ...
        sphere.pose.position =  marker_unity_position;
        sphere.pose.orientation = hololens_orientation;
        sphere.pose.orientation.w = 1.0;
    }
    else
    {
       sphere.pose.position =  interaction_marker_position;
       sphere.pose.orientation = hololens_orientation;
       sphere.pose.orientation.w = 1.0;
    ...
    publish_interactive_marker_to_rviz.publish(sphere);
