...
#include </home/luca/luca_ws/devel/include/scene_understanding_pkg_msgs/ObstacleRepForce.h>
...
//Parameters
    ...
    void voxblox_surface_pc_callback(const sensor_msgs::PointCloud2 &input)
    {
        ...
        cout << "size: " << pc_surface_.points.size() << endl;
        bool flagSurfacePointcloudVoxblox= true;
    }
...
//   }
    ...
    void publish_obstacle_force_resultant(float fx, float fy)
    {
